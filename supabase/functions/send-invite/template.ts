        ...
        <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08)">
          ...
          <tr>
            <td style="padding:32px 32px 0;text-align:center">
              ...
              <h1 style="margin:16px 0 4px;font-size:22px;font-weight:800;color:#1c1917">Te invitaron a <span style="color:#7C3AED">${workspaceName}</span></h1>
              <p style="margin:0;font-size:14px;color:#71717a">${invitedByName} te invitó como <strong>${roleLabel}</strong></p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:24px 32px;text-align:center">
              ...
              <p style="margin:4px 0 0;font-size:12px;color:#7C3AED;word-break:break-all">${inviteLink}</p>
            </td>
          </tr>
